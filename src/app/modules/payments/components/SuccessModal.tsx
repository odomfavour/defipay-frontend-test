...
const SuccessModal = (props: { show: boolean; handleClose:() => void; openPersonal:() => void; }) => {
    return (
        <div>
            <Modal className="modal fade" id="exampleModal" aria-labelledby="exampleModalLabel" size="lg" centered aria-hidden="true" show={props.show} onHide={props.handleClose} >
                ...
                <div className="modal-lg">
                    ...
                    <div className="modal-body">
                        ...
                        <p className="text-center">Your page is successfully created. 
                            Share your page link to start receiving payment</p>
                            <div className="mb-5">
                            ...
                            <button className='btn btn-warning' onClick={props.openPersonal}>Visit your page</button>
                            </div>
                        </div>
                    </div>
                    </div>
